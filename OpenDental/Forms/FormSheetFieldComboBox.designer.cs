namespace OpenDental{
	partial class FormSheetFieldComboBox {
		...
		private void InitializeComponent() {
			...
			this.textReportable = new OpenDental.ValidNum();
			...
			this.textTabOrder.TabIndex = 120;
			// 
			// label2
			// 
			...
			// textReportable
			// 
			this.textReportable.Location = new System.Drawing.Point(302, 36);
			this.textReportable.MaxVal = 2000;
			this.textReportable.MinVal = -100;
			this.textReportable.Name = "textReportable";
			this.textReportable.Size = new System.Drawing.Size(69, 20);
			this.textReportable.TabIndex = 122;
			// 
			// label3
			// 
    ...
    "set options.\r\n";
		...
		private ValidNum textReportable;
