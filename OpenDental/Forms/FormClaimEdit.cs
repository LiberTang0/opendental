...
///<summary></summary>
    ...
    "arrier.";
			...
			// textShareOfCost
			// 
			this.textShareOfCost.Location = new System.Drawing.Point(139, 105);
			...
			// label74
			// 
			this.label74.Location = new System.Drawing.Point(3, 109);
			...
			this.gridStatusHistory.Size = new System.Drawing.Size(513, 238);
			...
			// labelCustomTracking
			// 
			this.labelCustomTracking.Location = new System.Drawing.Point(40, 6);
			...
			this.comboCustomTracking.Location = new System.Drawing.Point(139, 3);
    ...
    "nt\" to finish this batch for daily reporting.";
      ...
      ClaimProcList=ClaimProcs.Refresh(PatCur.PatNum);
		...
		private void FillStatusHistory() {
			...
			ODGridColumn col=new ODGridColumn(Lan.g("TableStatusHistory","Date"),120);
			gridStatusHistory.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableStatusHistory","Description"),80);
			gridStatusHistory.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableStatusHistory","Log Note"),150);
			gridStatusHistory.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableStatusHistory","User"),60);
			gridStatusHistory.Columns.Add(col);
			gridStatusHistory.Rows.Clear();
			SecurityLog[] securityLogArray=SecurityLogs.Refresh(ClaimCur.PatNum,new List<Permissions> { Permissions.ClaimHistoryEdit },ClaimCur.ClaimNum);
			ODGridRow row;
