...
namespace OpenDental{
	public class FormEmailJobs : System.Windows.Forms.Form {
		...
		private List<FormJobSearch.FeatureRequest> _listFeatureReqs;
		...
		private void FormEmailJobs_Load(object sender, System.EventArgs e) {
			...
			_listFeatureReqs=FormJobSearch.FeatureRequest.GetMany(frNums);
		...
		private void FillComboEmail() {
			...
			List<Clinic> listClinicsAll = Clinics.GetList().ToList();
