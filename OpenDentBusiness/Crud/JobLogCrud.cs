...
namespace OpenDentBusiness.Crud{
	public class JobLogCrud {
		...
		public static long Insert(JobLog jobLog,bool useExistingPK){
			...
			command+="JobNum,UserNumChanged,UserNumExpert,UserNumEngineer,DateTimeEntry,Description,MainRTF) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
			...
			OdSqlParameter paramMainRTF=new OdSqlParameter("paramMainRTF",OdDbType.Text,jobLog.MainRTF);
			if(useExistingPK || PrefC.RandomKeys) {
				Db.NonQ(command,paramMainRTF);
			}
			else {
				jobLog.JobLogNum=Db.NonQ(command,true,paramMainRTF);
			}
